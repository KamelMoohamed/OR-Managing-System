...
const appointments = [
  {
    id: 0,
    title: "Neurologist",
    startDate: new Date(2022, 6, 9, 12, 30),
    endDate: new Date(2022, 6, 9, 16, 0),
    ownerId: 1,
  },
  {
    id: 0,
    ...
    endDate: new Date(2022, 6, 13, 16, 0),
    ownerId: 1,
  },
  {
    id: 0,
    title: "Cardiology",
    startDate: new Date(2022, 6, 10, 12, 30),
    endDate: new Date(2022, 6, 10, 16, 0),
    ownerId: 1,
  },
  {
    id: 0,
...
// const [appointment, setAppointment] = React.useState(appointments);
    ...
    return (
      <Card>
        <Scheduler data={data}>
          ...
          <ViewState defaultCurrentDate="2022-06-6" />
