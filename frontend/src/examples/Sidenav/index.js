    ...
    <SidenavRoot {...rest} variant="permanent" ownerState={{ transparentSidenav, miniSidenav }}>
      <SuiBox pt={3} pb={1} px={4} textAlign="center">
        ...
        <SuiBox component={NavLink} to="/" display="flex" alignItems="center">
          {<SuiBox component="img" src={logo} alt="CuOR Logo" width="10rem" />}
          <SuiBox
            width={!brandName && "100%"}
...
Sidenav.defaultProps = {
  color: "info",
  brand: "D:\\My PC\\Projects\\Web\\OR-Managing-System\\frontend\\src\\assets\\icon.png",
};
